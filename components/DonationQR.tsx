...
const DonationQR: React.FC<DonationQRProps> = ({ as = 'a', onClick }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-white/25 dark:bg-slate-900/25 backdrop-blur-xl transition-all duration-300 group-hover:opacity-0 group-hover:backdrop-blur-none elevation-overlay z-40">
