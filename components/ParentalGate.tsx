  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl max-w-sm w-full p-6 text-center">
        ...
        <h2 className="text-lg font-black text-slate-900 dark:text-white">Ask a grown-up!</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 mb-4">
          This leaves the games. A grown-up can answer to continue:
        </p>
        ...
        <input
          ...
          aria-label="Answer"
        />
        {wrong && <p className="text-xs font-bold text-rose-500 mb-1">Not quite — try again!</p>}
