...
export default function EventDetailsContent({ event }: { event: Event }) {
  const { eventRegistrations, registerForEvent, isLoading } = useData();
  const { user } = useAuth();
                    ...
                    {isRegistered ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-xl text-center">
                          ...
                          <Link href="/events" className="text-sm text-amber-600 dark:text-amber-300 hover:underline mt-1 inline-block">
