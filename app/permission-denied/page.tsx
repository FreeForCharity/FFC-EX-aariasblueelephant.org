...
export default function PermissionDeniedPage() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center pt-32">
      <div className="mb-6 rounded-full bg-red-500/10 p-6 ring-1 ring-red-500/20">
        <ShieldAlert className="h-16 w-16 text-red-500" />
      </div>
      <h1 className="mb-4 text-3xl font-bold text-slate-900 dark:text-white">Access Restricted</h1>
