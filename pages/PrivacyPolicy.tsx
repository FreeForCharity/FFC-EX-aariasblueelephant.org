            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
                    ...
                    <div id="age-restrictions" className="scroll-mt-32">
                        ...
                        <p>
                            Our website hosts free browser games designed for children (including Nilu's World, Block Craft 3D, Aaria's Elly-Tubbies, Aaria's Dough Lab, Magnet Blocks, Aaria's Road Safety Heroes, Aaria's Grocery Store, Aaria's Day Planner, and Nilu's Helping Hands). These games were deliberately built to <strong>collect no personal information from children</strong>:
                        </p>
                        <ul>
