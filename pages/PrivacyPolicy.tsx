            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
                    ...
                    <div id="age-restrictions" className="scroll-mt-32">
                        ...
                        <p>
                            Our website hosts free browser games designed for children (including Aaria's Floating Islands, Block Craft 3D, Aaria's Elly-Tubbies, Aaria's Dough Lab, Magnet Blocks, Aaria's Road Safety Heroes, Aaria's Grocery Store, Aaria's Day Planner, Aaria's Feelings Faces, and Aaria's Helping Hands). These games were deliberately built to <strong>collect no personal information from children</strong>:
                        </p>
                        <ul>
                            ...
                            <li><strong>No advertising and no tracking in the games.</strong> The game pages contain no ads, no ad networks, and no third-party analytics or tracking scripts. The only thing we count is an <strong>anonymous play tally</strong> — when a game starts, it tells us "this game was played once" and nothing else: no name, no account, no cookie, no device identifier, no IP address stored. We use these totals solely to understand which games children enjoy most.</li>
