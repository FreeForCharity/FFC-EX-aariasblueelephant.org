  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="w-full max-w-md space-y-8 bg-brand-card p-8 rounded-2xl border border-slate-700 shadow-2xl relative overflow-hidden">
        {/* Decorative blur */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-2 bg-gradient-to-r from-brand-purple to-brand-pink"></div>

        <div className="text-center">
          <div className="mx-auto h-24 w-24 rounded-full bg-white p-2 flex items-center justify-center mb-6 shadow-2xl ring-4 ring-brand-purple/20">
        ...
        <div className="mt-8 space-y-6">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full rounded-lg border-0 bg-slate-900 py-3 px-4 text-white shadow-sm ring-1 ring-inset ring-slate-700 placeholder:text-slate-500 focus:ring-2 focus:ring-inset focus:ring-brand-purple sm:text-sm sm:leading-6"
            ...
            <div>
              <Button type="submit" fullWidth disabled={isLoading} variant="primary" className="bg-gradient-to-r from-brand-purple to-brand-pink">
