# AI Agent Instructions: FFC-EX-aariasblueelephant.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-aariasblueelephant.org/` and optionally to a custom domain if one is configured for this repo.
