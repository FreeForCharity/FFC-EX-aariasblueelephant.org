...
HH.PREP = [
  ...
  {
    id: "shots", title: "Getting a Shot", emoji: "💉", place: "clinic",
    intro: "Let's practice getting a shot! I will show you everything that happens. No surprises.",
    steps: [
      { label: "See", emoji: "🪑",
        text: "First we sit in the waiting room. We wait for our turn, just like a doctor visit." },
      { label: "Hear", emoji: "📣",
        text: "Someone calls your name. That means it is your turn. You walk with your grown-up to a little room." },
      { label: "Smell", emoji: "🧴",
        text: "The nurse cleans a tiny spot on your arm with a cool wipe. It smells clean, like cotton. That smell means you are almost ready." },
      { label: "Feel", emoji: "👀",
        text: "It is okay to look away if you want. Some kids like to watch, some kids like to look somewhere else. Both ways are okay." },
      { label: "Feel + Practice", emoji: "🤲", coping: "squeeze",
        text: "The poke is fast — like a tiny pinch. One, two, three, and it is done. You can count with the nurse!",
        copingPrompt: "Let's practice the squeeze-hands trick for the poke. Tap the hands to squeeze… and let go!",
        copingDone: "Squeeze… and let go! You can squeeze your hands any time you feel a fast pinch." },
      { label: "See", emoji: "🩹",
        text: "Right after, you get a bandage or a sticker over the spot. You were so brave!" },
      { label: "All done", emoji: "🍭",
        text: "All done! The poke is over. You get a treat for being so brave." },
    ],
  },
  {
    id: "newclass", title: "A New Classroom", emoji: "🏫", place: "school",
    intro: "Let's practice a new classroom! I will show you everything that happens. No surprises.",
    steps: [
      { label: "See", emoji: "🚪",
        text: "First you find the door to your new classroom. Your name might be on a list by the door." },
      { label: "Meet", emoji: "🧑‍🏫",
        text: "Inside, you meet your new teacher. Their job is to help you learn and keep you safe, all day." },
      { label: "See", emoji: "🪑",
        text: "Next you find your seat. You might also have a cubby — a special spot just for your things." },
      { label: "See", emoji: "🚻",
        text: "The teacher shows you where the bathroom is. Now you know just where to go." },
      { label: "Practice", emoji: "✋", coping: "hand",
        text: "Here is your special tool: if you have a question, you can always raise your hand. The teacher will see it and come to help.",
        copingPrompt: "Let's practice one time. Tap the hand to raise your hand!",
        copingDone: "You raised your hand! You can always raise your hand to ask. The teacher is watching for it." },
      { label: "See", emoji: "🛝",
        text: "Recess is still recess! You still get to play outside with your class, just like before." },
      { label: "All done", emoji: "🎒",
        text: "All done! At home time, you pack your bag and go home. See you tomorrow!" },
    ],
  },
  {
    id: "firedrill", title: "Fire Drill at School", emoji: "🚨", place: "school",
    intro: "Let's practice a fire drill! I will show you everything that happens. No surprises.",
    steps: [
      { label: "Hear", emoji: "🚨",
        text: "The fire alarm makes a loud sound. It is very loud — but loud does not mean danger. Loud means practice." },
      { label: "Feel", emoji: "🙉",
        text: "It is okay to cover your ears if the sound is too loud. Covering your ears is a smart way to help your body." },
      { label: "See", emoji: "🚶",
        text: "Your teacher tells the class to line up. Everyone lines up together, just like we practiced." },
      { label: "Do", emoji: "🚪",
        text: "The class walks outside. We walk — we never run. Walking keeps everyone safe." },
      { label: "See", emoji: "🔢",
        text: "Outside, your teacher counts everyone in the class. One, two, three… everyone is here!" },
      { label: "Feel + Practice", emoji: "🫁", coping: "breath",
        text: "While we wait outside, our bodies can feel a little shaky from the loud sound. Let's take 3 slow breaths together.",
        copingPrompt: "Tap the circle to breathe with me — 3 slow breaths.",
        copingDone: "Three slow breaths! Your body feels calm again. The drill is almost over." },
      { label: "All done", emoji: "🏫",
        text: "All done! When the drill is over, the class walks back inside. Everyone is safe. It was only practice." },
    ],
  },
];
