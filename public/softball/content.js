...
(function () {
  ...
  C.start = {
    ...
    /* Two mirrored hands both labelled "this one" is a guessing game. Say
       which is which, in words, and put each on its own side of the screen. */
    handRight: t('RIGHT hand', 'Mano DERECHA'),
    handLeft: t('LEFT hand', 'Mano IZQUIERDA'),
    handRightHint: t('this side →', 'de este lado →'),
    handLeftHint: t('← this side', '← de este lado'),
  ...
  C.coachMode = {
    ...
    repsTitle: t('Turns at each station', 'Turnos en cada estación'),
    repsSub: t('How many times a child does each skill before it counts as done. Fewer for a short practice, more for a big day.',
               'Cuántas veces hace el niño cada habilidad antes de darla por hecha. Menos para una práctica corta, más para un día grande.'),
    repsDefault: t('as written', 'como está escrito'),
    cueAll: t('All', 'Todo'),
    goStation: t('🎯 Go straight to a station', '🎯 Ir directo a una estación'),
    goStationSub: t('Tap any station to open it and go there now. Use this to run one skill at practice, or to let someone start with the part they came for.',
                    'Toca cualquier estación para abrirla e ir ahí ahora. Úsalo para trabajar una sola habilidad en la práctica, o para que alguien empiece por la parte que vino a hacer.'),
    openAll: t('🔓 Open every station', '🔓 Abrir todas las estaciones'),
    openAllDone: t('All stations are open.', 'Todas las estaciones están abiertas.'),
