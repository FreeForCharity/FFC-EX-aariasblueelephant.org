...
(function () {
  ...
  C.gear = [
    { id: 'ball', emoji: '🥎', at: 'bag', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('We throw it and catch it', 'La lanzamos y la atrapamos'),
    ...
    { id: 'glove', emoji: '🧤', at: 'bag', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('It goes on your hand to catch', 'Va en tu mano para atrapar'),
    ...
    { id: 'bat', emoji: '🏏', at: 'rack', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('We swing it to hit the ball', 'Lo balanceamos para pegarle a la pelota'),
    ...
    { id: 'helmet', emoji: '⛑️', at: 'rack', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('It keeps your head safe when you bat', 'Protege tu cabeza cuando bateas'),
    ...
    { id: 'tee', emoji: '🔵', at: 'plate', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('It holds the ball still so you can hit it',
                 'Sostiene la pelota quieta para que le pegues'),
    ...
    { id: 'plate', emoji: '🏠', at: 'plate', kind: 'place', fnAsk: true,
      ...
      whatFor: t('You stand next to it to bat, and you run back to it to score',
                 'Te paras junto a él para batear, y regresas corriendo para anotar'),
    ...
    { id: 'first', emoji: '1️⃣', at: 'first', kind: 'place', fnAsk: true,
      ...
      whatFor: t('The first base you run to after you hit',
                 'La primera base a la que corres después de batear'),
    ...
    { id: 'second', emoji: '2️⃣', at: 'second', kind: 'place',
      ...
      whatFor: t('The base in the middle of the diamond',
                 'La base que está en medio del diamante'),
    ...
    { id: 'third', emoji: '3️⃣', at: 'third', kind: 'place',
      ...
      whatFor: t('The last base before you run home', 'La última base antes de correr al home'),
    ...
    { id: 'circle', emoji: '⚪', at: 'circle', kind: 'place',
      ...
      whatFor: t('Where the pitcher stands to pitch', 'Donde se para el pitcher para lanzar'),
    ...
    { id: 'dugout', emoji: '🪑', at: 'dugout', kind: 'place', fnAsk: true,
      ...
      whatFor: t('Where your team sits and waits', 'Donde tu equipo se sienta y espera'),
    ...
    { id: 'water', emoji: '💧', at: 'dugout', kind: 'thing', fnAsk: true,
      ...
      whatFor: t('You drink from it when you are thirsty', 'Tomas de ella cuando tienes sed'),
    ...
    { id: 'mask', emoji: '😷', at: 'rack', kind: 'thing',
      ...
      whatFor: t('It keeps the catcher\'s face safe', 'Protege la cara del cátcher'),
    ...
    { id: 'cleats', emoji: '👟', at: 'bag', kind: 'thing',
      ...
      whatFor: t('Shoes with bumps so you do not slip', 'Zapatos con picos para que no te resbales'),
    ...
    { id: 'fence', emoji: '🚧', at: 'fence', kind: 'place',
      ...
      whatFor: t('It marks the end of the field', 'Marca dónde termina el campo'),
  ...
  C.gearQ = {
    ...
    softMissFn: t('Good thinking! Let\'s try one more.', '¡Buena idea! Probemos otra vez.'),
